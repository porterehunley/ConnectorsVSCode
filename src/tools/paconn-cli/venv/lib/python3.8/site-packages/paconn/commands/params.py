...
from paconn import _LOGIN, _DOWNLOAD, _CREATE, _UPDATE, _VALIDATE, _CONNECTION
...
CONNECTION_ID_OPTIONS = ['--coid', '-co']
CONNECTION_ID_HELP = 'The custom connection ID.'
...
CONNECTION_PARAMS_OPTIONS = ['--con-params', '-cp']
CONNECTION_PARAMS_HELP = 'Location of the connection paramers JSON document.'
...
def load_arguments(self, command):
    ...
    with ArgumentsContext(self, _CONNECTION) as arg_context:
        arg_context.argument(
            ENVIRONMENT,
            options_list=ENVIRONMENT_OPTIONS,
            type=str,
        ...
        arg_context.argument(
            CONNECTION_PARAMS,
            options_list=CONNECTION_PARAMS_OPTIONS,
            type=str,
            required=True,
            help=CONNECTION_PARAMS_HELP)
        arg_context.argument(
            CONNECTOR_ID,
            options_list=CONNECTOR_ID_OPTIONS,
            type=str,
        ...
        arg_context.argument(
            CONNECTION_ID,
            options_list=CONNECTION_ID_OPTIONS,
            type=str,
            required=True,
            help=CONNECTION_ID_HELP)
