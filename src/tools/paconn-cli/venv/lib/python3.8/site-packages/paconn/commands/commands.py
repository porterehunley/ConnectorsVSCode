...
from paconn import _COMMAND_GROUP, _LOGIN, _LOGOUT, _DOWNLOAD, _CREATE, _UPDATE, _VALIDATE, _CONNECTION
...
def load_command_table(self, args):
    ...
    with CommandGroup(self, _COMMAND_GROUP, operation_group(_CONNECTION)) as command_group:
        command_group.command(_CONNECTION, _CONNECTION)
